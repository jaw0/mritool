...
(defvar load-path
  ...
  (list
   "/usr/local/lib/mritool/local-lisp"
   "/usr/local/lib/mritool/2.8/lisp"
   "/usr/local/lib/mritool/2.8/etc"         ; start grasping at straws
   "/home/sulcus/ur-cep/mritool-V2.7/lisp"
   "/home/sulcus/ur-cep/mritool-V2.7/jlisp"
   "/home/sulcus/ur-cep/mritool-V2.7/lib" ))
